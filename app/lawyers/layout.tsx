...
import { LawyerTourProvider, TourHelpButton, TourChapterPanel } from "@/components/lawyers/tour";
    ...
    <ThemeProvider attribute="class" forcedTheme="light">
      <LawyerTourProvider>
        <div className="flex min-h-screen bg-gray-50">
          ...
          >
            <LawyerSidebar collapsed={collapsed} onToggle={handleToggle} />
          </aside>
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="left" className="w-64 p-0">
              ...
              <LawyerSidebar collapsed={false} onToggle={() => setOpen(false)} />
            </SheetContent>
          </Sheet>
